...
export const SEARCH_INDEX: SearchEntry[] = [
  ...
  { title: "Products", description: "LifeOS and upcoming products", href: "/products", group: "Pages" },
  ...
  { title: "LifeOS", description: "Productivity and personal growth platform", href: "/products#lifeos", group: "Products" },
